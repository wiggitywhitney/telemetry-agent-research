...
| 2026-02-26 | Spec notation: JavaScript (JSDoc) everywhere | Agent code is JS (Decision 12). Spec interface blocks convert from TypeScript notation to JSDoc. Code examples convert from .ts to .js. Applies to M7 (interfaces and examples) and M8 (any remaining prose references). |

## Dependencies

- PRD #2: Evaluation report must exist before synthesis begins
- The telemetry agent spec (v3.8) at `docs/specs/telemetry-agent-spec-v3.8.md` in this repo
